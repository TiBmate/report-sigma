...
webRegistro = f"oilServicesSector"

# Nombre del archivo log
fileLog = f"04{webRegistro}.log"
...
# Nombre de archivo
fileCsv = f"{pathCsv}/datos_04{webRegistro}.csv"
...
url = "https://finance.yahoo.com/quote/%5EOSX/history/?ltr=1"

logging.info("Estableciendo los selectores")
selector_fecha = "#nimbus-app > section > section > section > article > div.container > div.table-container.yf-1jecxey > table > tbody > tr:nth-child(2) > td:nth-child(1)"
selector_valor = "#nimbus-app > section > section > section > article > div.container > div.table-container.yf-1jecxey > table > tbody > tr:nth-child(2) > td:nth-child(5)"
...
with sync_playwright() as p:
    browser = p.firefox.launch(headless=True, args=["--no-sandbox", "--disable-setuid-sandbox"])
