...
webRegistro = f"usCrudeOilInventory"

# Nombre del archivo log
fileLog = f"07{webRegistro}.log"
...
# URL y selectores
web = "https://www.eia.gov/"
url = "https://www.eia.gov/dnav/pet/pet_sum_sndw_dcus_nus_w.htm"

logging.info("Estableciendo los selectores")
selector_fecha = "body > div.l-body-wrapper > div.l-outer-wrapper > div > table.data1 > tbody > tr:nth-child(2) > th:nth-child(8)"
selector_valor = "body > div.l-body-wrapper > div.l-outer-wrapper > div > table.data1 > tbody > tr:nth-child(44) > td.Current2"
...
fecha = fecha.replace("\n", " ")
valor_float = parse_float(valor_str)

# Dividir por 1000 y descartar los decimales del cociente
valor_dividido = valor_float // 1000
# Formatear el número a dos decimales en formato string
valor = f"{valor_dividido:.2f}"
